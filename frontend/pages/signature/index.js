...
Page({
  data: {
    ...
    colors:["#000000","#003366","#FFCC33","#009966","#3399CC","#339933"]
  },

  onLineWeightChange:function(e){
    const weigth =  e.detail;
    console.log(weigth);
    this.setData({lineSize:weigth});
  },
  ...
  uploadScaleEnd (e) {
    ...
    if (currentLine.length > 2) {
      let info = (currentLine[0].time - currentLine[currentLine.length - 1].time) / currentLine.length;
    ...
    let chirography = this.data.chirography
  ...
  selectColorEvent (event) {
    console.log(event)
    let color = event.currentTarget.dataset.colorValue;
    let colorSelected = event.currentTarget.dataset.color;
    this.setData({
